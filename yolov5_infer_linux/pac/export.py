...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/myconfig/fire_smoke.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "detection/model_dir/yolov5s.pt", help="model.pt path(s)")
    ...
    parser.add_argument("--iou-thres", type=float, default=0.35, help="TF.js NMS: IoU threshold")
    parser.add_argument("--conf-thres", type=float, default=0.35, help="TF.js NMS: confidence threshold")
    parser.add_argument(
        "--include",
        nargs="+",
        default=["onnx"],
