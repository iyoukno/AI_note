...
parser.add_argument('--json_path', default=r'D:\datasets\road_det\train\annotations\train.json', type=str,
                    help="input: coco format(json)")
parser.add_argument('--save_path', default=r'D:\datasets\road_det\train\labels', type=str,
